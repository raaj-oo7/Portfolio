...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    years: 3,
    color: '#10b981',
    description: 'Schema design, aggregation pipelines and Atlas deployments for content-heavy apps.',
    highlights: ['Aggregation pipelines', 'Atlas & indexes', 'Mongoose / Prisma'],
  },
  {
    name: 'Tailwind CSS',
    category: 'Frontend',
  ...
  },
  {
    ...
    years: 3,
    color: '#fbbf24',
    description: 'Battle-tested APIs with auth, rate limiting, caching and clean layered architecture.',
    highlights: ['JWT auth', 'Middleware patterns', 'API versioning'],
  },
  {
    name: 'Firebase',
    category: 'Backend',
    ...
    years: 2,
    color: '#f97316',
    description: 'Realtime data, auth flows, cloud functions and rapid product prototyping.',
    highlights: ['Firestore', 'Auth', 'Cloud Functions'],
  },
  {
    name: 'Docker',
    category: 'DevOps',
    ...
    years: 2,
    color: '#38bdf8',
    description: 'Containerised dev environments and CI/CD pipelines for consistent deployments.',
    highlights: ['Multi-stage builds', 'Compose', 'CI/CD'],
  },
  {
    name: 'AWS',
    category: 'DevOps',
